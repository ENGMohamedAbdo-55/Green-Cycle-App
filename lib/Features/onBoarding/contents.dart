...
List<BoardingModel> boarding = [
  ...
  BoardingModel(
      ...
      body: " يمكنك بسهوله الحفاظ علي بيئتك نظيفه \n          من خلال استخدام تطبيقنا "),
  BoardingModel(
  ...
  children: [
    Stack(
      children: [
        ...
        Positioned(
          top: MediaQuery.of(context).size.height * 0.06, // Adjust this value to center the image vertically
          left: MediaQuery.of(context).size.width * 0.45 - 100, // Adjust this value to center the image horizontally
          child: Image(
